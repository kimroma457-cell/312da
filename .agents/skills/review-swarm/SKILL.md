...
license: MIT
compatibility: "Any codebase with git"
metadata:
  author: terminal-skills
  version: "1.0.0"
  category: development
  tags: [code-review, swarm, multi-agent, quality]
  use-cases:
    - "Run parallel code review on a diff"
    - "Find security, performance, and regression issues in changes"
