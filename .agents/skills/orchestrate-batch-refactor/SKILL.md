...
metadata:
  ...
  tags: [refactoring, multi-agent, batch, code-quality]
  use-cases:
    - "Batch refactor across many files with parallel agents"
    - "Coordinate large-scale code rewrites with dependency awareness"
